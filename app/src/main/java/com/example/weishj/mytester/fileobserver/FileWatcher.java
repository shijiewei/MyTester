package com.example.weishj.mytester.fileobserver;
...
public class FileWatcher extends FileObserver {
	public static final String TAG = "FileWatcher";
	...
	public void startWatching() {
		...
		if (mThread == null || !mThread.isAlive()) {
			mThread = new HandlerThread(mThreadName, android.os.Process.THREAD_PRIORITY_BACKGROUND);
			mThread.start();
